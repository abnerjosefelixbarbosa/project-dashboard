...
public record UpdateProjectResponse(String id, String name, String description,
		...
		String userName, String userEmail, String userPassword, @JsonFormat(pattern = "yyyy-MM-dd") Date userDateBirth) {
